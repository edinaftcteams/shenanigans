...
@Autonomous(name="Crater_Side_DropOnly", group="Pushbot")
//@Disabled
public class AutoNumberTwo extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        /*encoderDrive(DRIVE_SPEED, -16.0, -16.0, 4.0);             // S4: Reverse 30.0 Inches with 4 Sec timeout
        encoderDrive(DRIVE_SPEED, 10.0, -10.0, 4.0);                // S5: Turn 10 Inches Left with 4 Sec timeout
        ...
        encoderDrive(DRIVE_SPEED, -13.0, 13.0, 4.0);               // S9: Turn left 13 inches
        robot.markerDrop.setPosition(.52);                                                       // S10: Drop the marker
        sleep(1000);
        encoderDrive(DRIVE_SPEED, 22.0, 22.0, 4.0);
        */
